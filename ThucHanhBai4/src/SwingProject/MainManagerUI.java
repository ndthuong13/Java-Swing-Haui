...
public class MainManagerUI extends JFrame {
	...
	private static Category selectedCate;
	...
	public void addMenu() {
		...
		mnuFileOpenDataFromDisk = new JMenuItem("OpenData from disk");
	...
	public void addControl() {
		...
		JLabel lblTitle = new JLabel("Quan li san pham");
		...
		JLabel lblProductTitle = new JLabel("Thong ke chi tiet");
